namespace KAM_Task_04
{
    internal class Program
    {
        static void Main()
        {
            ...
            string[] UserSkills = { "Рашамон (Отнимает 10 хп игроку)", "Хуганзакура (Наносит 10 ед. урона) - После Рашамон", "Межпространственный разлом (Восстанавливает 25 хп. + урон босса по вам не проходит)", "Кефтен (Наносит 5 урона боссу)", "Мерба (Наносит 10 урона боссу, но наносит вам 5 урона) - После Кефтен" };
            int[] History = { -1 };
            ...
            Console.Write("Вы – теневой маг и у вас в арсенале есть несколько заклинаний, которые вы можете использовать против Босса. Вы должны уничтожить босса и только после этого будет вам покой.\n" +
